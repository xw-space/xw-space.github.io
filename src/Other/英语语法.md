...
- 在why not…和why…句型中，not和why后直接跟动词原形，构成反问，表示“建议、劝告、责备或提醒”等。
...
- 不定式作介词but和except的宾语，当其前有实意动词do时，后面的动词不定式要省略to
Jack had nothing to do but/except watch TV.（杰克除了看电视外无事可做）

- 在一些固定的句型中，如had better（最好）,would rather （宁愿）,would rather…that…（宁愿…而不）等后面的动词要用原形
